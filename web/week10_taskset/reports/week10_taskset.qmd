...
Save both your experiment_data and subject_means objects together as a single workspace file called objects.RData.

Then clear your environment (rm(list = ls)) and test whether you can reload them successfully. Copy and paste the reload command here:
